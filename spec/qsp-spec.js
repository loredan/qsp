...
describe('Qsp', () => {
  ...
  describe('when the qsp:toggle event is triggered', () => {
    it('hides and shows the modal panel', () => {
      ...
      // has been created
      expect(workspaceElement.querySelector('.qsp')).not.toExist();
      ...
      runs(() => {
        expect(workspaceElement.querySelector('.qsp')).toExist();

        let qspElement = workspaceElement.querySelector('.qsp');
